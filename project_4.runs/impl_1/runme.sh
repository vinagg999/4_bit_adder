...
HD_PWD='C:/Users/eictguest/Desktop/Vinay_Subrat_Sachin/4_bit_adder/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_adder_4.tcl -notrace
