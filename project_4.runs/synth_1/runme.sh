...
HD_PWD='C:/Users/eictguest/Desktop/Vinay_Subrat_Sachin/4_bit_adder/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_4.tcl
